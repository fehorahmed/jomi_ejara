...
@section('title', 'Land Lease Order Edit')
@push('styles')
        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>Land Lease Order Update</h5>
                        <span>Here is Land Lease Order update form.</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <form id="campaign-form" class="form-horizontal" method="post"
                                        action="{{ route('admin.land-lease.update', $data->id) }}"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                ...
                                                <select name="dag_no" class="js-example-basic-single col-sm-12"
                                                    ...
                                                    @foreach ($dags as $dag)
                                                        <option
                                                            {{ old('dag_no', $data->dag_list_id) == $dag->id ? 'selected' : '' }}
                                                            value="{{ $dag->id }}">{{ $dag->bn_name }},
                                                            {{ $dag->upazila->bn_name }},
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="date" name="application_end_date"
                                                    value="{{ old('application_end_date', $data->application_end_date) }}"
                                                    id="application_end_date" class="form-control">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="radio" name="status" id="CANCEL"
                                                    {{ old('status', $data->status) == 'CANCEL' ? 'checked' : '' }}
                                                    value="CANCEL" class="form-radio"> <label for="CANCEL">
                                                    CANCEL</label>
                                        ...
                                        <div class="text-center mb-3">
                                            ...
                                            <input type="submit" class="btn btn-primary  " value="Land Lease Order Update">
                                        </div>
                                    </form>
                                </div>
