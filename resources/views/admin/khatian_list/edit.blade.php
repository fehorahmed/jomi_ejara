...
@section('title', 'Khatian No Update')
        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>Khatian No Update</h5>
                        <span>Here is the Khatian No update form.</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                        ...
                        <div class="col-md-8 m-auto">
                            <div class="card">
                                <div class="card-header bg-info">
                                    <h5 class="text-white"> Khatian No Update Form</h5>
                                    <span>Add class of <code>.form-control</code> with
                                        <code>&lt;input&gt;</code> tag</span>
                                </div>
                                <div class="card-block">
                                    <form id="campaign-form" class="form-horizontal" method="post"
                                        action="{{ route('admin.khatian-list.update', $khatianList->id) }}"
                                            ...
                                            <div class="col-12 col-md-9">
                                                <select name="upazila" id="upazila"
                                                    ...
                                                    @foreach ($upazilas as $upazila)
                                                        <option
                                                            {{ old('upazila', $khatianList->upazila_id) == $upazila->id ? 'selected' : '' }}
                                                            value="{{ $upazila->id }}">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <select name="khatian_type" id="khatian_type"
                                                    ...
                                                    @foreach ($khatianTypes as $khatianType)
                                                        <option
                                                            {{ old('khatian_type', $khatianList->khatian_type_id) == $khatianType->id ? 'selected' : '' }}
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="bn_name"
                                                    value="{{ old('bn_name', $khatianList->bn_name) }}" id="bn_name"
                                                    class="form-control" placeholder="Khatian No ">
                                                @error('bn_name')
                                                    <div class="help-block text-danger">{{ $message }} </div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="owner_name"
                                                    value="{{ old('owner_name', $khatianList->owner_name) }}"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="radio" name="status" value="1"
                                                    {{ old('status', $khatianList->status) == '1' ? 'checked' : '' }}
                                                    id="status1"> <label for="status1" class="col-form-label">
                                                    Active</label>
                                                <input type="radio" name="status" value="0"
                                                    {{ old('status', $khatianList->status) == '0' ? 'checked' : '' }}
...
@push('scripts')
    <script>
        $(function() {
            var unionPourashavaSelected = '{{ old('union_pourashava', $khatianList->union_pourashava_id) }}';
            ...
            var mouzaSelected = '{{ old('mouza', $khatianList->mouza_id) }}';
