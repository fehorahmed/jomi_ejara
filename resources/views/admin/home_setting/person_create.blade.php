                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <form id="campaign-form" class="form-horizontal" method="post"
                                        action="{{ route('admin.home-setting.person.create') }}"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="designation" value="{{ old('designation') }}"
                                                    id="designation" class="form-control" placeholder="Enter Designation">
                                                @error('designation')
                                                    <div class="help-block text-danger">{{ $message }} </div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="text-center mb-3">
                                            ...
                                            <input type="submit" class="btn btn-primary  " value="Store Person">
                                        </div>
                                    </form>
                                </div>
                            </div>
