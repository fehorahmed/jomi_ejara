        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>Mouza Create</h5>
                        <span>Here is the Mouza create form.</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                        ...
                        <div class="col-md-8 m-auto">
                            <div class="card">
                                <div class="card-header bg-info">
                                    <h5 class="text-white"> Mouza Create Form</h5>
                                    <span>Add class of <code>.form-control</code> with
                                        <code>&lt;input&gt;</code> tag</span>
                                </div>
                                <div class="card-block">
                                    <form id="campaign-form" class="form-horizontal" method="post"
                                        action="{{ route('admin.mouza.store') }}" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="bn_name" value="{{ old('bn_name') }}"
                                                    id="bn_name" class="form-control" placeholder="Mouza bangla name">
                                                @error('bn_name')
                                                    <div class="help-block text-danger">{{ $message }} </div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="j_l_no" value="{{ old('j_l_no') }}"
                                                    id="j_l_no" class="form-control" placeholder="Enter J L No">
                                                @error('j_l_no')
                                                    <div class="help-block text-danger">{{ $message }} </div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="text-center mb-3">
                                            ...
                                            <input type="submit" class="btn btn-primary  " value="Add Mouza">
                                        </div>
                                    </form>
                                </div>
                            </div>
