        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>Upazila Update</h5>
                        <span>Here is the district update form.</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                        ...
                        <div class="col-md-8 m-auto">
                            <div class="card">
                                <div class="card-header bg-info">
                                    <h5 class="text-white"> Upazila Update Form</h5>
                                    <span>Add class of <code>.form-control</code> with
                                        <code>&lt;input&gt;</code> tag</span>
                                </div>
                                <div class="card-block">
                                    <form id="campaign-form" class="form-horizontal" method="post"
                                        action="{{ route('admin.upazila.update', $upazila->id) }}"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="row mb-3">
                                            <label for="bn_name" class="col-12 col-md-3 col-form-label">Upazila
                                                Name</label>
                                            <div class="col-12 col-md-9">
                                                <input type="bn_name" name="bn_name"
                                                    value="{{ old('bn_name', $upazila->bn_name) }}" id="bn_name"
                                        ...
                                        <div class="text-center mb-3">
                                            ...
                                            <input type="submit" class="btn btn-primary  " value="Update Upazila">
                                        </div>
                                    </form>
                                </div>
...
@push('scripts')
    <script>
        $(function() {
            var districtSelected = '{{ old('district', $upazila->district_id) }}';
