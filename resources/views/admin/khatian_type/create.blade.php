...
@section('title', 'Khatian Type Create')
        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>Khatian Type Create</h5>
                        <span>Here is the khatian type create form.</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        <li class="breadcrumb-item">
                            <a class="btn btn-primary" href="{{ route('admin.khatian-type.index') }}">Upazila List</a>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="col-md-8 m-auto">
                            <div class="card">
                                <div class="card-header bg-info">
                                    <h5 class="text-white"> Khatian Type Create Form</h5>
                                    <span>Add class of <code>.form-control</code> with
                                        <code>&lt;input&gt;</code> tag</span>
                                </div>
                                <div class="card-block">
                                    <form id="campaign-form" class="form-horizontal" method="post"
                                        action="{{ route('admin.khatian-type.store') }}" enctype="multipart/form-data">
                                        @csrf

                                        <div class="row mb-3">
                                            <label for="email" class="col-12 col-md-3 col-form-label">Khatian Type
                                                Name</label>
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="bn_name" value="{{ old('bn_name') }}"
                                                    id="bn_name" class="form-control"
                                                    placeholder="Khatian Type bangla name">
                                                @error('bn_name')
                                        ...
                                        <div class="text-center mb-3">
                                            ...
                                            <input type="submit" class="btn btn-primary  " value="Add Khatian Type">
                                        </div>
                                    </form>
                                </div>
                            </div>
