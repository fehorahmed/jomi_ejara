        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>Land Lease Application Payments</h5>
                        <span>Here is the list of Land Lease Application Payments.</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                                            ...
                                            <tbody>
                                                @foreach ($datas as $data)
                                                    <tr>
                                                        ...
                                                        <td>{{ $data->landLeaseApplication->dagList->bn_name }},{{ $data->landLeaseApplication->dagList->upazila->bn_name }},
                                                        ...
                                                        <td>
                                                            <b>Name : </b> {{ $data->landLeaseApplication->user->name }}
                                                            <br>
                                                            <b>Phone : </b> {{ $data->landLeaseApplication->user->phone }}
                                                            <br>
                                                            <b>Email : </b> {{ $data->landLeaseApplication->user->email }}
                                                            <br>
                                                        </td>
                                                        <td>
