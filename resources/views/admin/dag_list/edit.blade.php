        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>Dag No Update</h5>
                        <span>Here is the Dag No Update form.</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                        ...
                        <div class="col-md-8 m-auto">
                            <div class="card">
                                <div class="card-header bg-info">
                                    <h5 class="text-white"> Dag No Update Form</h5>
                                    <span>Add class of <code>.form-control</code> with
                                        <code>&lt;input&gt;</code> tag</span>
                                </div>
                                <div class="card-block">
                                    <form id="campaign-form" class="form-horizontal" method="post"
                                        action="{{ route('admin.dag-list.update', $dagList->id) }}"
                                            ...
                                            <div class="col-12 col-md-9">
                                                <select name="upazila" id="upazila"
                                                    ...
                                                    @foreach ($upazilas as $upazila)
                                                        <option
                                                            {{ old('upazila', $dagList->upazila_id) == $upazila->id ? 'selected' : '' }}
                                                            value="{{ $upazila->id }}">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <select name="khatian_type" id="khatian_type"
                                                    ...
                                                    @foreach ($khatianTypes as $khatianType)
                                                        <option
                                                            {{ old('khatian_type', $dagList->khatian_type_id) == $khatianType->id ? 'selected' : '' }}
                                                ...
                                                <select name="ejara_rate" id="ejara_rate"
                                                    ...
                                                    @foreach ($ejara_rates as $ejara_rate)
                                                        <option value="{{ $ejara_rate->id }}"
                                                            {{ old('ejara_rate', $dagList->ejara_rate_id) == $ejara_rate->id ? 'selected' : '' }}>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="bn_name"
                                                    value="{{ old('bn_name', $dagList->bn_name) }}" id="bn_name"
                                                    class="form-control" placeholder="Enter Dag No ">
                                                @error('bn_name')
                                                    <div class="help-block text-danger">{{ $message }} </div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-8 col-md-4">
                                                <input type="number" name="land_amount"
                                                    value="{{ old('land_amount', $dagList->land_amount) }}"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="owner_hisar_part"
                                                    value="{{ old('owner_hisar_part', $dagList->owner_hisar_part) }}"
                                                    id="owner_hisar_part" class="form-control"
                                                    placeholder="Enter Owner Hisar Part ">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="occupied_land"
                                                    value="{{ old('occupied_land', $dagList->occupied_land) }}"
                                                    id="occupied_land" class="form-control"
                                                    placeholder="Enter Occupied Land ">
                                                @error('occupied_land')
                                                    <div class="help-block text-danger">{{ $message }} </div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="unoccupied_land"
                                                    value="{{ old('unoccupied_land', $dagList->unoccupied_land) }}"
                                                    id="unoccupied_land" class="form-control"
                                                    placeholder="Enter Unoccupied Land ">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="land_condition"
                                                    value="{{ old('land_condition', $dagList->land_condition) }}"
                                                    id="land_condition" class="form-control"
                                                    placeholder="Enter Land Condition">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <textarea name="remarks" class="form-control" id="remarks" cols="30" rows="3">{{ old('remarks', $dagList->remarks) }}</textarea>
                                                @error('remarks')
                                                    <div class="help-block text-danger">{{ $message }} </div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="text-center mb-3">
                                            ...
                                            <input type="submit" class="btn btn-primary  " value="Update Khatian No">
                                        </div>
                                    </form>
                                </div>
                            </div>
...
@push('scripts')
    <script>
        $(function() {
            var unionPourashavaSelected = '{{ old('union_pourashava', $dagList->union_pourashava_id) }}';
            ...
            var mouzaSelected = '{{ old('mouza', $dagList->mouza_id) }}';
            ...
            //  $('#khatian_type').trigger('change');
            var khatianNoSelected = '{{ old('khatian_no', $dagList->khatian_list_id) }}';
