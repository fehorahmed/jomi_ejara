...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/auth-sign-in-social.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Aug 2023 11:54:46 GMT -->
                ...
                <div class="col-sm-12">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="md-float-material form-material">
                        ...
                        <div class="text-center">
                            <img src="../files/assets/images/download.png" height="150" width="150" alt="logo.png">
                        </div>
