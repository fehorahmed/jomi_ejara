...
<div class="container user_panel">
    ...
    @endphp
    <div class="card ">
        <div class=""> <img src="https://templates.joomla-monster.com/joomla30/jm-news-portal/components/com_djclassifieds/assets/images/default_profile.png" class="imag"> </div>
        ...
        <div class="row">
            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div class="man-service_one">
                    <div class="lang_enbn">
                        <a class="btn btn-xs Bn_lang" target="_blank" href="{{ url('profile_pdf?uid=' . $user->id . '&token=' . csrf_token())  }}" target="_blank">
                            বাংলা
                        </a>

                        <a class="btn btn-xs En_lang" href="{{ url('profile_pdf?uid=' . $user->id . '&token=' . csrf_token()) }}">
                            EN
                        </a>
                    </div>
                    <a target="_blank" href="{{ url('profile_pdf?uid=' . $user->id . '&token=' . csrf_token()) }}" target="_blank">
                        <img src="{{ url('public/icons/profile.png') }}">
                    </a>
                    <a target="_blank" href="{{ url('profile_pdf?uid=' . $user->id . '&token=' . csrf_token()) }}">
                        <h1>
                            প্রোফাইল
                        </h1>
                    </a>
            ...
            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div class="man-service_one">
                    ...
                    <a target="_blank" href="" target="_blank">
                        ...
                        <img src="http://192.168.0.101/pourashava/storage/uploads/fullsize/2019-07/marketshop.png">
                    </a>
                    <a target="_blank" href="" target="_blank">
                        <h1>
                            আমার দোকান
        ...
        <div class="row w-100">
            <div class="col-md-4">
                <div class="card border-info mx-sm-1 p-3">
                    ...
                    <div class="text-success text-center mt-2">
                        <h1>
                            <?php $total_all =  \App\Rent::where('created_at', '>=', date('Y-m-d') . ' 00:00:00')->where('rent_status', 'yes')->get()->sum('rent_amount'); ?>
                            {{ $total_all }}
                        </h1>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card border-success mx-sm-1 p-3">
                    ...
                    <div class="text-danger text-center mt-2">
                        <h1>
                            <?php $total_all = \App\Payment::where('created_at', '>=', date('Y-m-d') . ' 00:00:00')->where('digi_center_user_id', Auth::user()->id)->whereRaw('to_uni IS NOT NULL')->get()->sum('to_uni'); ?>
                            {{ $total_all }}
                        </h1>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card border-danger mx-sm-1 p-3">
                    ...
                    <div class="text-danger text-center mt-2">
                        <h1>
                            <?php $total_all = \App\Payment::where('digi_center_user_id', Auth::user()->id)->whereRaw('to_uni IS NOT NULL')->get()->sum('to_uni'); ?>
                            {{ $total_all }}
                        </h1>
                    </div>
                </div>
