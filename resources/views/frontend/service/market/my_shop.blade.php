                                    ...
                                    <form class="form-inline">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control searche_type" name="land_class">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control searche_user" name="searche_user" placeholder="Searche..." data-user="{{$user['user_id']}}" data-shop="{{$list->id}}" data-asid="{{$list->as_id}}">
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <ul class="wid-data-list">
                            <li><i class="fa fa-square" aria-hidden="true"></i> চুক্তি শুরুঃ <span class="pull-right">
                                    {{ e_to_b(date('d-F-Y', strtotime($list->agreement_start))) }}
                                </span></li>
                            <li><i class="fa fa-square" aria-hidden="true"></i> চুক্তি শেষঃ <span class="pull-right">
                                    {{ e_to_b(date('d-F-Y', strtotime($list->agreement_end))) }}
                                </span></li>
                            <li><i class="fa fa-square" aria-hidden="true"></i> দোকান নং <span class="pull-right">{{ e_to_b($list->shop_number) }} </span></li>
                        </ul>
                    </div>
                    <div class="col-xs-6">
                        <ul class="wid-data-list">
                            <li><i class="fa fa-square" aria-hidden="true"></i> দোকান ইনডেক্সঃ <span class="pull-right">{{ ($list->shop_index)? e_to_b($list->shop_index): 'নাই' }} </span>
                            </li>
                            <li><i class="fa fa-square" aria-hidden="true"></i> মোট পেঃ <span class="pull-right">{{ e_to_b($get_info['paid']). ' টাকা' }}</span>
                            </li>
                            <li><i class="fa fa-square" aria-hidden="true"></i> মোট বকেয়াঃ <span class="pull-right">{{ e_to_b($get_info['due']). ' টাকা' }}</span>
                            </li>
                        </ul>
                    </div>
                </div>
...
<div class="container user_panel">
    ...
    <div class="form-group">
        ...
        <input type="text" name="start_date" class="form-control date-pick" id="start_date" placeholder="Start Date" autocomplete="off" value="{{ ($is_date)? Request::get('start_date') : NULL }}">
    </div>
    <div class="form-group">
        <label for="end_date">To</label>
        <input type="text" name="end_date" class="form-control date-pick" id="end_date" placeholder="End Date" autocomplete="off" value="{{ ($is_date)? Request::get('end_date') : NULL }}">
    </div>
