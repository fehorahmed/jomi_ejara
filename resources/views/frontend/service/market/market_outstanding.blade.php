...
$rents = $rents->whereDate('create_date', '<=',$end); } $rents=$rents->where('rent_status', 'No' );
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" class="checkBoxClass" name="month_pay[]" value="{{ $data->id }}" data-rent="{{ $data->rent_amount }}" data-fine="{{ get_rent_fine($data->id) }}">
                            </label>
                        </div>
                        @endif
                    </td>
                    ...
                    <td>
                        <small>
                            ...
                            <a href="javascript:void(0)" class="btn btn-danger btn-xs" onclick="alert('Please select the checkbox and go to payment option to pay')">বাকি</a>
                            @else
