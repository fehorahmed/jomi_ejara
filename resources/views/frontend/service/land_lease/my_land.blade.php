        ...
        <div class="col-md-6 wid-area">
            <div class="row wid-title-sec">
                ...
                <div class="col-xs-5">
                    ...
                    <button type="button" class="btn btn-danger pull-right" data-toggle="modal" data-target="#land_transfer_model_{{$list->id}}">
                        হস্তান্তর
                    </button>
                    @else
                    ...
                    @php
                    $check_land = App\LandLease::where('land_id', $list->id)->orderBy('id', 'desc')->first();
                    @endphp
                    <!-- Button trigger modal -->
                    <!--{{ url('land_renew_aplication/'.$list->id) }}-->
                    <a @if ($check_land) @if($check_land->request_status == 'Granted' && $check_land->is_form_fee == 'Pending')
                        href="{{ url('land_renew_aplication/'.$list->id) }}"
                        @else
                        href="javascript:void(0)" data-toggle="modal" data-target="#exampleModalLong"
                        @endif
                        @else
                        href="javascript:void(0)" data-toggle="modal" data-target="#exampleModalLong"
                        @endif class="btn btn-danger pull-right">
                        নবায়ন
                    </a>
                    <!-- Modal -->
                    <div class=" exModal modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h3 class="modal-title" id="exampleModalLongTitle"> জমি ইজারা নবায়ন আবেদন ফর্ম </h3>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <form class="modal-body" action="{{route('user_lease_application')}}" method="post">
                                    {{ csrf_field() }}
                                    <input type="hidden" value="{{Auth::user()->id}}" name="ownner_id">
                                    <input type="hidden" value="{{$list->id}}" name="id">
                                    <input type="hidden" value="{{$list->lease_amount}}" name="lease_amount">
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"> ইনডেক্স নাম্বার : </label>
                                                    <input type="text" name="index" value="{{$list->land_title}}" class="form-control" id="exampleInputEmail1" placeholder="ইনডেক্স নাম্বার ">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"> উপজেলা </label>
                                                    <input type="text" name="upazila" value="{{$list->upazila}}" class="form-control" id="exampleInputEmail1" placeholder="উপজেলা ">
                                                </div>

                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"> মৌজাঃ </label>
                                                    <input type="text" name="mouza" value="{{$list->mouza}}" class="form-control" id="exampleInputEmail1" placeholder="মৌজাঃ ">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"> জে.এল.নংঃ </label>
                                                    <input type="text" name="jl_no" value="{{$list->jl_no}}" class="form-control" id="exampleInputEmail1" placeholder="জে.এল.নংঃ ">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"> খতিয়ানঃ </label>
                                                    <input type="text" name="ledger" value="{{$list->khotian}}" class="form-control" id="exampleInputEmail1" placeholder="খতিয়ানঃ ">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"> দাগঃ </label>
                                                    <input type="text" name="dhag" value="{{$list->dhag}}" class="form-control" id="exampleInputEmail1" placeholder="দাগঃ ">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"> জমির পরিমাণঃ </label>
                                                    <input type="text" name="land_amount" value="{{$list->area_of_land}}" class="form-control" id="exampleInputEmail1" placeholder="জমির পরিমাণঃ ">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"> শ্রেণী </label>
                                                    <input type="text" name="type" value="{{$list->land_class}}" class="form-control" id="exampleInputEmail1" placeholder="শ্রেণী ">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"> বর্তমান অবস্থা </label>
                                                    <input type="text" value="{{$list->current_status_of_land}}" name="present_situation" class="form-control" id="exampleInputEmail1" placeholder="বর্তমান অবস্থা ">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"> start </label>
                                                    <input type="date" value="{{$list->lease_start}}" name="lease_start" class="form-control" id="exampleInputEmail1" placeholder="সর্বশেষ ইজারা পরিশোধের মেয়াদ ">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"> end </label>
                                                    <input type="date" value="{{$list->lease_end}}" name="lease_end" class="form-control" id="exampleInputEmail1" placeholder="সর্বশেষ ইজারা পরিশোধের মেয়াদ ">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="modal fade" id="land_renew_model_{{$list->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="payment_info[payment_method]" id="pm_bankdraft" value="Bank draft" onchange="payment_option(this);" data-id="{{$list->id}}" checked>
                                        ...
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="payment_info[payment_method]" id="pm_bkash" value="Bkash" onchange="payment_option(this);" data-id="{{$list->id}}">
                                                বিকাশ
                                            </label>
                                        </div>
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="payment_info[payment_method]" id="pm_nagot" value="Nagat" onchange="payment_option(this);" data-id="{{$list->id}}">
                                                নগদ
                                            </label>
                                        </div>
                                    </div>
                    ...
                    <!-- Modal -->
                    @endif
                    <div class="modal fade" id="land_transfer_model_{{$list->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <ul class="wid-data-list">
                            <li><i class="fa fa-square" aria-hidden="true"></i> জমির পরিমানঃ <span class="pull-right">{{ e_to_b($list->area_of_land) }} শতাংশ </span></li>
                            <li><i class="fa fa-square" aria-hidden="true"></i> উপজেলাঃ <span class="pull-right">{{ e_to_b($list->upazila) }}</span></li>
                            <li><i class="fa fa-square" aria-hidden="true"></i> মৌজাঃ <span class="pull-right">{{ e_to_b($list->mouza) }} </span></li>
                    </div>
                    <div class="col-xs-6">
                        <ul class="wid-data-list">
                            <li><i class="fa fa-square" aria-hidden="true"></i> জে. এল. নং <span class="pull-right">{{ e_to_b($list->jl_no) }} </span></li>
                            <li><i class="fa fa-square" aria-hidden="true"></i> খতিয়ানঃ <span class="pull-right">{{ e_to_b($list->khotian) }} </span></li>
                            <li><i class="fa fa-square" aria-hidden="true"></i> দাগঃ <span class="pull-right">{{ e_to_b($list->dhag) }}</span></li>
                        </ul>
                    </div>
                </div>
            </div>
