            ...
            <div style="max-width: 550px; margin:  auto">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel" style="text-align: center;">
                        ইজারাকৃত জমি  ইজারা নবায়নের  আবেদন।
                    </h4>
                </div>
                        ...
                        <div class="input-group" style="margin-bottom: 5px">
                            <div class="input-group-addon" style="min-width: 165px">
                                <div class="input-group-text" id="rent_amount_co">
                                    আবেদন ফি    :{{ $land_setting->renew_fee }}
                                </div>
                            </div>
                            <div class="input-group-addon">
                                <div class="input-group-text">মোট টাকা</div>
                            </div>                           
                            {{ Form::number('payment_info[amount]',$land_setting->renew_fee+$list['lease_amount'], ['required', 'class' => 'form-control', 'placeholder' => 'টাকার পরিমাণ..','readonly']) }}
